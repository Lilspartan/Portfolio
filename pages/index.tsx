				...
				<div data-m="drop" data-m-delay="0.5">
					<Card>
						...
						<div className="text-white flex flex-row justify-center">
							...
							<a data-m-delay="0.75" data-m="bounce-down" data-m-duration = "0.75" href="mailto:gabe@gabekrahulik.dev" target="_new"><SiGmail className="transition duration-300 mx-2 mt-8 text-4xl hover:text-gmail" /></a>
