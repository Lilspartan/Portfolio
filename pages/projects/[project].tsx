										...
										<div className = "text-white">
											<div id = "images" className = "flex flex-row gap-8 overflow-x-scroll pb-4">
												{ project.detail.trailer && (
													<iframe loading="lazy" className = "h-52 aspect-video" src={`${project.detail.trailer}`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
												)}
											...
											<div>
												...
												<div className="my-2 text-left flex flex-col lg:flex-row gap-8 mb-8 lg:mb-0">
													{ project.detail.tech.map((section, i) => (
														<div className = "flex flex-col">
															{ project.detail.tech.length > 1 && <h3 className = "font-semibold text-lg mt-2" data-m = "bounce-up" data-m-delay = {i * 0.5}>{ section.name }</h3> }
