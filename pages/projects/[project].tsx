									...
									project.infoPage !== null ? (
										<div className = "text-white">
											<div id = "images" className = "flex flex-row gap-8 overflow-x-scroll pb-4">
												{ project.trailer && (
													<iframe loading="lazy" className = "h-52 aspect-video" src={`${project.trailer}`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
												)}
